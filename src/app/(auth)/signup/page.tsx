...
export default function SignupPage() {
  ...
  const { signup, loginWithGoogle, error, loading, clearError, isFirebaseConfigured } = useAuth();
    ...
    >
      <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-8">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-400">PICKSO Cruise와 함께 여행을 시작하세요</p>
        </div>
        ...
        {!isFirebaseConfigured && (
          ...
          >
            ...
            <p className="text-amber-400/80 text-xs">
              회원가입 기능을 사용하려면 .env.local 파일에 Firebase 환경 변수를 설정해주세요.
            </p>
          </motion.div>
        )}
